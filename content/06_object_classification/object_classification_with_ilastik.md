...
In this exercise, we will use the **instance segmentation** data from the nuclei dataset that we generated from the [From Ilastik Masks to Labels](../05_segmentation/machine_learning/from_ilastik_masks_to_labels.ipynb) exercise and train a model to separate cells into *mitotic* vs *non-mitotic* states. We will also need the raw data from the <a href="https://github.com/bobiac/bobiac-book/releases/download/data-bobiac-2026/05_segmentation_ilastik.zip" download> <i class="fas fa-download"></i> Ilastik Pixel Classification Dataset</a> we used to generate the instance segmentation images.
