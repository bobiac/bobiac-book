# 01 - <i class="fab fa-python"></i> Getting Started with Python and `uv`
...
<a
    class="custom-button custom-download-button" href="../../pdfs/01_getting_started_with_python/getting_started_python_uv.pdf" download> <i class="fas fa-download"></i> Download the Slides
</a>

<div align="center">
  <iframe class="custom-pdf-frame-34" src="../../pdfs/01_getting_started_with_python/getting_started_python_uv.pdf"> </iframe>
</div>
