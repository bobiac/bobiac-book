...
To install `uv` you can follow these [uv installation instructions](https://bobiac.github.io/uv_instruction.html) or follow the [uv documentation](https://docs.astral.sh/uv/getting-started/installation).
