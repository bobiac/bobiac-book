...
exclude_patterns = [
    ...
    # during development.
    # "content/00_intro_to_bobiac/**",
    # "content/01_getting_started_with_python/**",
    # "content/02_python_basics/**",
    # "content/03_digital_images_intro/**",
    # "content/04_segmentation/**",
    # "content/04_segmentation/classic/**",
    # "content/04_segmentation/deep_learning/**",
    # "content/04_segmentation/machine_learning/**",
